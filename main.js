...
import { shader as particleVertexShader } from "./particle-vs.js";
import { shader as particleFragmentShader } from "./particle-fs.js";
...
function initScene() {
  ...
  var sphereGeometry = new IcosahedronBufferGeometry(100, 5);
...
function animate() {
  ...
  simulationShader.uniforms.time.value = 0.0001 * performance.now();
